...
<pre>Javascript (encoder only) - <a rel="nofollow" class="external free" href="https://github.com/subpos/ssid_coder/blob/master/coder/ssid_coder.js">https://github.com/subpos/ssid_coder/blob/master/coder/ssid_coder.js</a>
</pre>
...
<!-- Saved in parser cache with key subposor_spwiki-spw_:pcache:idhash:53-0!canonical and timestamp 20191107050826 and revision id 502
 -->
		...
		<div class="printfooter">Retrieved from "<a dir="ltr" href="http://subpos.org/wiki/index.php?title=Coding_Mask_Calculation&amp;oldid=502">http://subpos.org/wiki/index.php?title=Coding_Mask_Calculation&amp;oldid=502</a>"</div>
		...
		<div id="mw-navigation">
			...
			<div id="mw-head">
						...
						<ul>
							<li id="pt-login"><a href="http://subpos.org/wiki/index.php?title=Special:UserLogin&amp;returnto=Coding+Mask+Calculation&amp;returntoquery=oldid%3D502" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>						</ul>
					</div>
				...
				<div id="right-navigation">
						...
						<ul>
							<li id="ca-view" class="collapsible selected"><span><a href="http://subpos.org/wiki/index.php/Coding_Mask_Calculation">Read</a></span></li><li id="ca-viewsource" class="collapsible"><span><a href="http://subpos.org/wiki/index.php?title=Coding_Mask_Calculation&amp;action=edit" title="This page is protected.&#10;You can view its source [e]" accesskey="e">View source</a></span></li><li id="ca-history" class="collapsible"><span><a href="http://subpos.org/wiki/index.php?title=Coding_Mask_Calculation&amp;action=history" title="Past revisions of this page [h]" accesskey="h">View history</a></span></li>						</ul>
					</div>
