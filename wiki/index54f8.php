...
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-4 ns-subject page-SubPos_About rootpage-SubPos_About skin-vector action-edit">
...
<div id="content" class="mw-body" role="main">
	...
	<h1 id="firstHeading" class="firstHeading" lang="en">View source for SubPos:About</h1>
	
	<div id="bodyContent" class="mw-body-content">
		
		<div id="contentSub">← <a href="http://subpos.org/wiki/index.php/SubPos:About" title="SubPos:About">SubPos:About</a></div>
...
SubPos defines an accurate method for subterraneous positioning in different environments by exploiting all the capabilities of Wi-Fi. SubPos Nodes or existing Wi-Fi access points are used to transmit encoded information in a standard Wi-Fi beacon frame which is then used for position calculation by a device of your choice (as long as it contains a Wi-Fi receiver).
</textarea><div class="templatesUsed"></div><p id="mw-returnto">Return to <a href="http://subpos.org/wiki/index.php/SubPos:About" title="SubPos:About">SubPos:About</a>.</p>
</div>
		...
		<div id="mw-navigation">
			...
			<div id="mw-head">
						...
						<ul>
							<li id="pt-login"><a href="http://subpos.org/wiki/index.php?title=Special:UserLogin&amp;returnto=SubPos%3AAbout&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>						</ul>
					</div>
				...
				<div id="right-navigation">
						...
						<ul>
							<li id="ca-view" class="collapsible"><span><a href="http://subpos.org/wiki/index.php/SubPos:About">Read</a></span></li><li id="ca-viewsource" class="collapsible selected"><span><a href="http://subpos.org/wiki/index.php?title=SubPos:About&amp;action=edit" title="This page is protected.&#10;You can view its source [e]" accesskey="e">View source</a></span></li><li id="ca-history" class="collapsible"><span><a href="http://subpos.org/wiki/index.php?title=SubPos:About&amp;action=history" title="Past revisions of this page [h]" accesskey="h">View history</a></span></li>						</ul>
					</div>
