...
</p><p><a href="http://subpos.org/wiki/index.php/File:How_subpos_works.png" class="image"><img alt="How subpos works.png" src="http://subpos.org/wiki/images/thumb/3/32/How_subpos_works.png/500px-How_subpos_works.png" decoding="async" width="500" height="450" srcset="/wiki/images/3/32/How_subpos_works.png 1.5x" /></a>
</p><p>The transmitter and Node position information is <a href="http://subpos.org/wiki/index.php/Coded_Beacon_Frame" title="Coded Beacon Frame">coded</a> into the Wi-Fi beacon frame that is sent by a Node, using a technique called <a rel="nofollow" class="external text" href="http://research.microsoft.com/pubs/73482/BeaconStuffing.pdf">beacon stuffing</a>. This allows a client to use this calculated distance from the transmitter and receiver, as well as the known position of the Nodes to easily determine its position. All of this is performed without the need for data connectivity as it's determined purely with the information received from visible Nodes.
...
<a href="http://subpos.org/wiki/index.php/File:Coded.png" class="image"><img alt="Coded.png" src="http://subpos.org/wiki/images/thumb/5/5f/Coded.png/500px-Coded.png" decoding="async" width="500" height="270" srcset="/wiki/images/thumb/5/5f/Coded.png/750px-Coded.png 1.5x, /wiki/images/5/5f/Coded.png 2x" /></a>
...
<p><a href="http://subpos.org/wiki/index.php/File:API.png" class="image"><img alt="API.png" src="http://subpos.org/wiki/images/thumb/e/ea/API.png/200px-API.png" decoding="async" width="200" height="333" srcset="/wiki/images/thumb/e/ea/API.png/300px-API.png 1.5x, /wiki/images/thumb/e/ea/API.png/400px-API.png 2x" /></a>
...
</p><p><a href="http://subpos.org/wiki/index.php/File:Nodes.png" class="image"><img alt="Nodes.png" src="http://subpos.org/wiki/images/thumb/9/9d/Nodes.png/500px-Nodes.png" decoding="async" width="500" height="267" srcset="/wiki/images/thumb/9/9d/Nodes.png/750px-Nodes.png 1.5x, /wiki/images/thumb/9/9d/Nodes.png/1000px-Nodes.png 2x" /></a>
</p>
<!-- 
NewPP limit report
...
<!-- Saved in parser cache with key subposor_spwiki-spw_:pcache:idhash:17-0!canonical and timestamp 20191107051000 and revision id 300
 -->
		...
		<div class="printfooter">Retrieved from "<a dir="ltr" href="http://subpos.org/wiki/index.php?title=SubPos:How_it_works&amp;oldid=300">http://subpos.org/wiki/index.php?title=SubPos:How_it_works&amp;oldid=300</a>"</div>
		...
		<div id="mw-navigation">
			...
			<div id="mw-head">
						...
						<ul>
							<li id="pt-login"><a href="http://subpos.org/wiki/index.php?title=Special:UserLogin&amp;returnto=SubPos%3AHow+it+works&amp;returntoquery=oldid%3D300" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>						</ul>
					</div>
				...
				<div id="right-navigation">
						...
						<ul>
							<li id="ca-view" class="collapsible selected"><span><a href="http://subpos.org/wiki/index.php/SubPos:How_it_works">Read</a></span></li><li id="ca-viewsource" class="collapsible"><span><a href="http://subpos.org/wiki/index.php?title=SubPos:How_it_works&amp;action=edit" title="This page is protected.&#10;You can view its source [e]" accesskey="e">View source</a></span></li><li id="ca-history" class="collapsible"><span><a href="http://subpos.org/wiki/index.php?title=SubPos:How_it_works&amp;action=history" title="Past revisions of this page [h]" accesskey="h">View history</a></span></li>						</ul>
					</div>
