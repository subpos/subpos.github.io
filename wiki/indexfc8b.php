...
<div id="content" class="mw-body" role="main">
	...
	<div id="bodyContent" class="mw-body-content">
		...
		<div id="mw-content-text" lang="en" dir="ltr" class="mw-content-ltr"><div class="mw-parser-output"><p>Currently registered Applications IDs. <a href="http://subpos.org/wiki/index.php/Special:Contact" class="new" title="Special:Contact (page does not exist)">Contact us</a> to register a new Application ID.
</p>
...
<td><a href="http://subpos.org/wiki/index.php/Use_in_Caving" title="Use in Caving">Breadcrumb mode</a>. No positioning available (which means lower processing requirements on smartphone), but can tag rooms and can be placed on topological maps if desired.
</td>
<td>04/05/2015
</td>
<td>N/A
...
<!-- Saved in parser cache with key subposor_spwiki-spw_:pcache:idhash:7-0!canonical and timestamp 20191107050800 and revision id 495
 -->
		...
		<div class="printfooter">Retrieved from "<a dir="ltr" href="http://subpos.org/wiki/index.php?title=Application_IDs&amp;oldid=495">http://subpos.org/wiki/index.php?title=Application_IDs&amp;oldid=495</a>"</div>
		...
		<div id="mw-navigation">
			...
			<div id="mw-head">
						...
						<ul>
							<li id="pt-login"><a href="http://subpos.org/wiki/index.php?title=Special:UserLogin&amp;returnto=Application+IDs&amp;returntoquery=oldid%3D495" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>						</ul>
					</div>
				...
				<div id="right-navigation">
						...
						<ul>
							<li id="ca-view" class="collapsible selected"><span><a href="http://subpos.org/wiki/index.php/Application_IDs">Read</a></span></li><li id="ca-viewsource" class="collapsible"><span><a href="http://subpos.org/wiki/index.php?title=Application_IDs&amp;action=edit" title="This page is protected.&#10;You can view its source [e]" accesskey="e">View source</a></span></li><li id="ca-history" class="collapsible"><span><a href="http://subpos.org/wiki/index.php?title=Application_IDs&amp;action=history" title="Past revisions of this page [h]" accesskey="h">View history</a></span></li>						</ul>
					</div>
