...
<div id="content" class="mw-body" role="main">
	...
	<div id="bodyContent" class="mw-body-content">
		...
		<div id="mw-content-text"><div class="mw-ui-container"><div id="userloginprompt"></div><div id="userloginForm"><form class="mw-htmlform mw-ui-vform mw-ui-container" action="http://subpos.org/wiki/index.php?title=Special:UserLogin&amp;returnto=File:API.png" method="post" name="userlogin"><div>
...
<input name="wpLoginToken" type="hidden" value="cb0467af41b98795056c2eac439fe9c25dc3ac28+\"/>
</form></div></div></div>
		...
		<div id="mw-navigation">
			...
			<div id="mw-head">
						...
						<ul>
							<li id="pt-login" class="active"><a href="http://subpos.org/wiki/index.php?title=Special:UserLogin&amp;returnto=File%3AAPI.png" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>						</ul>
					</div>
									<div id="left-navigation">
										<div id="p-namespaces" role="navigation" class="vectorTabs" aria-labelledby="p-namespaces-label">
						<h3 id="p-namespaces-label">Namespaces</h3>
						<ul>
							<li id="ca-nstab-special" class="selected"><span><a href="http://subpos.org/wiki/index.php?title=Special:UserLogin&amp;returnto=File%3AAPI.png" title="This is a special page, and it cannot be edited">Special page</a></span></li>						</ul>
					</div>
