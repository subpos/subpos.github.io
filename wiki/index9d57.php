...
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-SSID_Position_Codec rootpage-SSID_Position_Codec skin-vector action-edit">
...
<div id="content" class="mw-body" role="main">
	...
	<h1 id="firstHeading" class="firstHeading" lang="en">View source for SSID Position Codec</h1>
	
	<div id="bodyContent" class="mw-body-content">
		
		<div id="contentSub">← <a href="http://subpos.org/wiki/index.php/SSID_Position_Codec" title="SSID Position Codec">SSID Position Codec</a></div>
...
</p><textarea readonly="" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" class="mw-editfont-monospace" lang="en" dir="ltr" name="wpTextbox1">https://github.com/subpos/ssid_coder/blob/master/coder/ssid_coder.c
...
The encoder is designed to be adjusted to work with any access point by masking out invalid characters. For the decoding segment, it doesn't have to know about these characters as it is encoded in such a way that it knows how to reverse any combination of encoded SSIDs. This many to one relationship is what makes SubPos work with almost any device.
</textarea><div class="templatesUsed"></div><p id="mw-returnto">Return to <a href="http://subpos.org/wiki/index.php/SSID_Position_Codec" title="SSID Position Codec">SSID Position Codec</a>.</p>
</div>
		...
		<div id="mw-navigation">
			...
			<div id="mw-head">
						...
						<ul>
							<li id="pt-login"><a href="http://subpos.org/wiki/index.php?title=Special:UserLogin&amp;returnto=SSID+Position+Codec&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>						</ul>
					</div>
				...
				<div id="right-navigation">
						...
						<ul>
							<li id="ca-view" class="collapsible"><span><a href="http://subpos.org/wiki/index.php/SSID_Position_Codec">Read</a></span></li><li id="ca-viewsource" class="collapsible selected"><span><a href="http://subpos.org/wiki/index.php?title=SSID_Position_Codec&amp;action=edit" title="This page is protected.&#10;You can view its source [e]" accesskey="e">View source</a></span></li><li id="ca-history" class="collapsible"><span><a href="http://subpos.org/wiki/index.php?title=SSID_Position_Codec&amp;action=history" title="Past revisions of this page [h]" accesskey="h">View history</a></span></li>						</ul>
					</div>
