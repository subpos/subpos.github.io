...
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-4 ns-subject page-SubPos_Documentation rootpage-SubPos_Documentation skin-vector action-edit">
...
<div id="content" class="mw-body" role="main">
	...
	<h1 id="firstHeading" class="firstHeading" lang="en">View source for SubPos:Documentation</h1>
	
	<div id="bodyContent" class="mw-body-content">
		
		<div id="contentSub">← <a href="http://subpos.org/wiki/index.php/SubPos:Documentation" title="SubPos:Documentation">SubPos:Documentation</a></div>
...
== SubPos Wi-Fi Positioning Standard ==


  [[SubPos Wi-Fi Positioning Standard|The Standard]]

[[Details]]

[[SubPos:How it works|How the SubPos Wi-Fi Positioning Standard works]]

[https://hackaday.io/project/4872/instructions Setup Guide for ESP/NodeMCU/Nodes]
...
[[Javascript SSID Coder|Javascript SSID Coder]]

[[Access Point Support|Access Point Support]]
...
[https://hackaday.io/project/9242-subpos-ranger Ranger Blog]
</textarea><div class="templatesUsed"></div><p id="mw-returnto">Return to <a href="http://subpos.org/wiki/index.php/SubPos:Documentation" title="SubPos:Documentation">SubPos:Documentation</a>.</p>
</div>
		...
		<div id="mw-navigation">
			...
			<div id="mw-head">
						...
						<ul>
							<li id="pt-login"><a href="http://subpos.org/wiki/index.php?title=Special:UserLogin&amp;returnto=SubPos%3ADocumentation&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>						</ul>
					</div>
				...
				<div id="right-navigation">
						...
						<ul>
							<li id="ca-view" class="collapsible"><span><a href="http://subpos.org/wiki/index.php/SubPos:Documentation">Read</a></span></li><li id="ca-viewsource" class="collapsible selected"><span><a href="http://subpos.org/wiki/index.php?title=SubPos:Documentation&amp;action=edit" title="This page is protected.&#10;You can view its source [e]" accesskey="e">View source</a></span></li><li id="ca-history" class="collapsible"><span><a href="http://subpos.org/wiki/index.php?title=SubPos:Documentation&amp;action=history" title="Past revisions of this page [h]" accesskey="h">View history</a></span></li>						</ul>
					</div>
