...
<input name="wpLoginToken" type="hidden" value="5672d5bbbeafb464a01ba9e1fe9f57bf5dc3ab73+\"/>
</form></div></div></div>
		...
		<div id="mw-navigation">
			...
			<div id="mw-head">
						...
						<ul>
							<li id="pt-login" class="active"><a href="http://subpos.org/wiki/index.php?title=Special:UserLogin&amp;returnto=SubPos%3APrivacy+policy&amp;returntoquery=printable%3Dyes" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>						</ul>
					</div>
									<div id="left-navigation">
										<div id="p-namespaces" role="navigation" class="vectorTabs" aria-labelledby="p-namespaces-label">
						<h3 id="p-namespaces-label">Namespaces</h3>
						<ul>
							<li id="ca-nstab-special" class="selected"><span><a href="http://subpos.org/wiki/index.php?title=Special:UserLogin&amp;returnto=SubPos%3APrivacy+policy&amp;returntoquery=printable%3Dyes" title="This is a special page, and it cannot be edited">Special page</a></span></li>						</ul>
					</div>
